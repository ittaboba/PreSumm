...
Then put `stanford-corenlp-full-2017-06-09` in the root folder of this repo.
...
See *CustomDataPreparationExample* to see an example of intermediate steps' outputs
